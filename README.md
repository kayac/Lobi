...
Lobi REC SDK・Ranking SDKサービス終了のお知らせ
-----------
Lobi REC SDK・Ranking SDKをご利用いただき、ありがとうございます。

長きにわたってご愛顧いただいております本サービスにつきまして、
誠に勝手ではございますが、2018年2月28日をもってサービス終了の運びとなりました。
いままで、本サービスをご利用いただき、誠にありがとうございました。
また、サービス終了に伴い、皆様に多大なご迷惑をおかけすることにつきまして深くお詫び申し上げます。

終了までのスケジュールにつきましては、下記のように予定しております。

■2017年11月2日(木)
・REC SDK、Ranking SDKの配布およびテクニカルサポート終了 

■2018年2月28日(水) 15時以降
・REC SDK、Ranking SDKのサーバー停止（録画・閲覧機能含めて、すべての機能が停止します）

ご不便ご迷惑をおかけいたしますが、何卒ご理解のほどお願い申し上げます。

なお、本内容に関するゲームアプリ内でのユーザー様向けのお知らせを掲出する際には、下記のLobiユーザー様向け告知記事のURLをご利用ください。
https://web.lobi.co/blog/news/0d22bbaefa966e18e6b8db47fa11878128c2ef82

今後は、ゲーム開発者の皆様が、管理画面からLobiに開設したコミュニティの分析をおこなうことができたり、オンライントーナメントを開催できるようにするなど、コミュニティをより活性化できる機能開発にフォーカスしてまいります。
コミュニティの活用方法や、他社成功事例・ご要望などございましたら、お気軽にご相談いただけますと幸いです。

これまでのLobi REC SDK・Ranking SDKへのご愛顧に深く感謝するとともに、心よりお礼申し上げます。
